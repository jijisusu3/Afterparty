...
/**
 * 공연 KOPIS 관련 API 요청 처리를 위한 컨트롤러 정의.
 */

@Api(value = "공연 KOPIS 호출 API", tags = {"Perform"})
@RestController
...
public class PerformController {
    ...
    public ResponseEntity<PerformInfoRes> getPerformInfo(@PathVariable("mt20id") String mt20id) {
